<?php
namespace App\Bsclass;
use Illuminate\Console\Application as Artisan;
use Livewire\ComponentHook;
class LivewireCommands extends ComponentHook
{
    // this is a my livewire commands add for my project
    // this function register in AppServiceProvider in method name is mylivewirecmd() 
